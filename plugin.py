...
"""
<plugin key="IKEA-Tradfri" name="IKEA Tradfri Plugin - version 0.9.4" author="moroen" version="0.9.4" externallink="https://github.com/moroen/IKEA-Tradfri-plugin">
    <description>
...
class BasePlugin:
    ...
    def updateDevice(self, Unit, device_id=None, override_level=None, just_update_domoticz=False):
    ...
    def onCommand(self, Unit, Command, Level, Hue):
        ...
        try:
            ...
            if Command == "On":
                ...
                self.updateDevice(Unit, just_update_domoticz=True)
