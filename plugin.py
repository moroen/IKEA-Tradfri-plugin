...
#
"""
<plugin key="IKEA-Tradfri" name="IKEA Tradfri Plugin - version 0.7.2" author="moroen" version="0.7.2" wikilink="http://www.domoticz.com/wiki/plugins/plugin.html" externallink="https://www.google.com/">
    <description>
